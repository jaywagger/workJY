...
/*
 * <<상속관계에서 멤버변수가 갖는 특징>>
 * 1. 상속관계에서는 상위클래스에 정의된 멤버변수를 하위클래스에서 사용할 
 *    수 있다.(하위클래스 참조 변수를 통해서 접근할 수 있다.)
...
class Sub extends Super{
	int num=1000;
	public void display() {
		System.out.println("num=>"+num);//부모클래스의 변수를
		                                //액세스할 수 있다.
		//System.out.println("부모의 num=>"+super.num); private 때메
													// 직접 접근 노
		System.out.println("부모의 num=>"+super.getNum()); //간접접근
	}
}
